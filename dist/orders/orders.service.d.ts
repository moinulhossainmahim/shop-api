...
export declare class OrdersService {
    ...
    getAllOrdersOfAUser(user: User, pageOptionsDto: PageOptionsDto): Promise<ApiGetResponse<any>>;
    ...
    getAllUsersOrders(pageOptionsDto: PageOptionsDto): Promise<ApiGetResponse<any>>;
}
