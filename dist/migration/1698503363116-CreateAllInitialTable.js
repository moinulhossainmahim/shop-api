...
exports.CreateAllInitialTable1698503363116 = void 0;
class CreateAllInitialTable1698503363116 {
    constructor() {
        this.name = 'CreateAllInitialTable1698503363116';
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE \`order\` (\`id\` varchar(36) NOT NULL, \`tracking_no\` varchar(255) NOT NULL DEFAULT '202310286067', \`order_date\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`order_status\` varchar(255) NOT NULL DEFAULT 'pending', \`delivery_fee\` decimal(10,2) NOT NULL, \`total\` decimal(10,2) NOT NULL, \`amount\` decimal(10,2) NOT NULL, \`payment_status\` varchar(255) NOT NULL, \`payment_method\` varchar(255) NOT NULL, \`shippingAddressId\` varchar(36) NULL, \`billingAddressId\` varchar(36) NULL, \`userId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`user\` (\`id\` varchar(36) NOT NULL, \`fullName\` varchar(255) NOT NULL, \`password\` varchar(255) NOT NULL, \`avatar\` varchar(255) NOT NULL DEFAULT '', \`email\` varchar(255) NOT NULL, \`contact\` varchar(255) NOT NULL, \`salt\` varchar(255) NOT NULL, \`userType\` varchar(255) NOT NULL DEFAULT 'customer', \`status\` varchar(255) NOT NULL DEFAULT 'active', UNIQUE INDEX \`IDX_e12875dfb3b1d92d7d7c5377e2\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`address\` (\`id\` varchar(36) NOT NULL, \`title\` varchar(255) NOT NULL, \`country\` varchar(255) NOT NULL, \`city\` varchar(255) NOT NULL, \`state\` varchar(255) NOT NULL, \`zip\` varchar(255) NOT NULL, \`streetAddress\` varchar(255) NOT NULL, \`addressType\` varchar(255) NOT NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, \`userId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
...
exports.CreateAllInitialTable1698503363116 = CreateAllInitialTable1698503363116;
//# sourceMappingURL=1698503363116-CreateAllInitialTable.js.map