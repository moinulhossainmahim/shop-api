...
let ProductsService = exports.ProductsService = class ProductsService {
    ...
    async getAllProducts(pageOptionsDto, filterOptionsDto) {
        try {
            ...
            if (filterOptionsDto.category) {
                queryBuilder = queryBuilder.andWhere('categories.slug = :categorySlug', { categorySlug: filterOptionsDto.category });
            }
            if (filterOptionsDto.subCategory) {
                queryBuilder = queryBuilder.andWhere('subcategories.slug = :subcategorySlug', { subcategorySlug: filterOptionsDto.subCategory });
            }
