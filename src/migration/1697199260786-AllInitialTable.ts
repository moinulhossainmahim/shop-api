...
export class AllInitialTable1697199260786 implements MigrationInterface {
  name = 'AllInitialTable1697199260786';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE \`order\` (\`id\` varchar(36) NOT NULL, \`tracking_no\` varchar(255) NOT NULL, \`order_date\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`order_status\` varchar(255) NOT NULL DEFAULT 'pending', \`delivery_fee\` decimal(10,2) NOT NULL, \`total\` decimal(10,2) NOT NULL, \`tax\` decimal(10,2) NOT NULL, \`payment_status\` varchar(255) NOT NULL, \`payment_method\` varchar(255) NOT NULL, \`shipping_address\` text NOT NULL, \`billing_address\` text NOT NULL, \`userId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE \`product\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(255) NOT NULL, \`desc\` varchar(255) NOT NULL, \`status\` varchar(255) NOT NULL, \`featuredImg\` varchar(255) NOT NULL, \`galleryImg\` text NOT NULL, \`unit\` varchar(255) NOT NULL, \`price\` decimal(10,2) NOT NULL, \`salePrice\` decimal(10,2) NOT NULL, \`quantity\` int NOT NULL, \`sku\` varchar(255) NOT NULL, \`slug\` varchar(255) NOT NULL, UNIQUE INDEX \`IDX_22cc43e9a74d7498546e9a63e7\` (\`name\`), UNIQUE INDEX \`IDX_34f6ca1cd897cc926bdcca1ca3\` (\`sku\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
