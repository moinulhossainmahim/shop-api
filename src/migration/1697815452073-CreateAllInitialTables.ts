...
export class CreateAllInitialTables1697815452073 implements MigrationInterface {
    name = 'CreateAllInitialTables1697815452073'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`sub_category\` ADD CONSTRAINT \`FK_51b8c0b349725210c4bd8b9b7a7\` FOREIGN KEY (\`categoryId\`) REFERENCES \`categories\`(\`id\`) ON DELETE SET NULL ON UPDATE CASCADE`);
